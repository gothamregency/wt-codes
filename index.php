...
<head>
    ...
    <?php 
        ...
        $apiKey = "50c4b164c27747eb85a31933241505";
        try {
            $json = @file_get_contents("http://api.weatherapi.com/v1/forecast.json?key={$apiKey}&q={$searchCity}&days=3&aqi=yes&alerts=yes");
        } catch (Exception $e) {
        ...
        if (! isset($json)) {
            ...
            $dateCpy = date_create($todayDate);
            $time = strftime("%A, %d %b'%y", $todayDate);
            $twentyFourHourTime = strftime("%H:%M", $todayDate);
            ...
            $formattedDate = "{$twentyFourHourTime} - {$time}";
                ...
                <div class="container overflow-y-scroll overflow-x-visible" onscroll="revealOnScroll">
                    ...
                    <div class="fade-element flex items-center translate-y-72">
                        ...
                        <div class="flex flex-col px-4">
                            <div class="text-3xl font-medium flex items-end">
                                <p class="text-acrylicWhite">
                                <?php echo"$currentCity" ?>
                                </p>
                                <p class="text-2xl font-medium text-acrylicWhite">
                                    <?php echo ", $currentCountry" ?>
                                </p>
                        </div>
                        <div class="text-xl">
                            <p class="text-acrylicWhite">
